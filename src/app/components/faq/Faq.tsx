    ...
    return(
        <div className="font-gilroy mt-[100px]">
            ...
            <div className="grid justify-center mt-[25px]">
                <div className={question1 ? "bg-[#202020] w-[800px] h-[200px] rounded-xl hover:cursor-pointer" : "bg-[#202020] w-[800px] h-[65px] rounded-xl hover:cursor-pointer"} onClick={(() => setQuestion1(!question1))}>
                    <p className="font-gilroy_600 text-white m-[10px] text-[20px] mt-[17px] ml-[20px]">What is "ProductGem" & What We Do ?</p>
                    <p className={question1 ? "text-white mt-[20px] text-[20px] ml-[20px] mr-[20px]" : "text-white mt-[20px] text-[20px] ml-[20px] mr-[20px] hidden"}>
